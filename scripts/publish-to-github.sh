...
libVersion=$( cat ../dist/ngx-material-custom/package.json | jq -r ".version");
...
libName=$( cat ../dist/ngx-material-custom/package.json | jq -r ".name");
...
libDescription=$( cat ../dist/ngx-material-custom/package.json | jq -r ".description");
