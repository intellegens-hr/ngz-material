...
export class NgxIntellegensGridShowcaseComponent {
  ...
  public dataSource = [
    ...
    { location: 4, firstName: 'Judy', lastName: 'Brown', salary: 2400 },
    ...
    { location: 14, firstName: 'Judy', lastName: 'Brown', salary: 1500 },
    ...
    { location: 19, firstName: 'Judy', lastName: 'Brown', salary: 1900 },
    ...
    { location: 24, firstName: 'Judy', lastName: 'Brown', salary: 1200 },
